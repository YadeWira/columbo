...
flowchart TD
    ...
    R9 -- "No" --> PICKMAX["Select byte/meaningful-bit winner<br/>or relaxed raw source"]
    COUPLED --> PICKMAX
```
...
no mandatory
Default work, extra time or grace. The final Max incumbent may also receive R6–R9
after R5 while G0 remains open.
